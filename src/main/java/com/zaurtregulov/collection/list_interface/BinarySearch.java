...
public class BinarySearch {
    public static void main(String[] args) {
        ...
        System.out.println("arrayList reverse sorting = " + arrayList);
        Collections.shuffle(arrayList);
        System.out.println("arrayList shuffle (mix) = " + arrayList);
        ...
        Arrays.sort(array);
        System.out.println("Arrays.toString(array) other sorting = " + Arrays.toString(array));
